...
const AddFirm = () => {
  ...
  return (
   ...
   {loading &&        <div className="loaderSection">
        ...
        />
         ...
         {!loading &&   <form className="tableForm" onSubmit={handleFirmSubmit}>
            <h1>Add Firm</h1>
                ...
                <input type="text" name='firmName' value={firmName} onChange={(e)=>setFirmName(e.target.value)} placeholder='Enter the Firm name'/>
                <label >Area</label>
                <input type="text"  name='area' value={area} onChange={(e)=>setArea(e.target.value)} placeholder='Enter the area' />
    ...
    <label >Offer</label>
                <input type="text" name='offer' value={offer} onChange={(e)=>setOffer(e.target.value)} placeholder='Enter the Offer'/>
    <div className="checkInp">
      <label >Region</label>
          <div className="inputsContainer">
